...
import { RewardBalance, shouldShowRewardBalance } from './_components/reward-balance';
...
export default async function DashboardPage() {
  ...
  return (
    <section className='mx-auto max-w-2xl px-4 pb-10 pt-4 min-[380px]:px-5 sm:px-12 sm:pb-16 sm:pt-6 lg:max-w-[50rem] lg:pt-8'>
